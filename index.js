document.getElementById("encode-button").addEventListener("click", function () {
    ...
    for (var i = 0; i < message.length; i++) {
        if (message[i].charCodeAt(i) > 127) {
            document.getElementById("encode-output").innerHTML = "sorry, we aren't able to handle non-ascii characters at this time. for an explanation on why, check out the background page!";
            return;
        }
    }
